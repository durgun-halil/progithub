...
class Mastermind:
    ...
    def draw_board(self, event=None):
        ...
        self.canvas.pack()
        self.bag = {'c': self.canvas.create_oval(960, 0, 1027, 66, fill='cyan', outline='cyan'),
                    'm': self.canvas.create_oval(960, 66, 1027, 131, fill='magenta', outline='magenta'),
                    ...
                    'R': self.canvas.create_oval(960, 334, 1027, 400, fill='red', outline='red')
                    }
        self.ids = {v: k for k, v in self.bag.items()}
        self.colors = {'c': 'cyan', 'm': 'magenta', 'y': 'yellow',
